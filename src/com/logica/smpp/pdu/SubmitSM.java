...
public class SubmitSM extends Request
{
    ...
    public boolean hasMoreMsgsToSend()         { return moreMsgsToSend.hasValue(); }
    ...
    public boolean hasUserResponseCode()       { return userResponseCode.hasValue(); }
    ...
    public boolean hasNumberOfMessages()       { return numberOfMessages.hasValue(); }
    ...
    public boolean hasItsSessionInfo()         { return itsSessionInfo.hasValue(); }
    ...
    public void setItsSessionInfo(short value)        { itsSessionInfo.setValue(value); }
    ...
    throws ValueNotSetException { return moreMsgsToSend.getValue(); }
    ...
    throws ValueNotSetException { return userResponseCode.getValue(); }
    ...
    throws ValueNotSetException { return numberOfMessages.getValue(); }
    ...
    throws ValueNotSetException { return itsReplyType.getValue(); }

    public short getItsSessionInfo() 
    throws ValueNotSetException { return itsSessionInfo.getValue(); }

    public byte getUssdServiceOp() 
    throws ValueNotSetException { return ussdServiceOp.getValue(); }
    ...
    public String debugString()
    {
        ...
        dbgs += getDestAddr().debugString(); dbgs += " ";
