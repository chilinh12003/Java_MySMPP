...
public abstract class ByteData extends SmppObject
{
    ...
    throws WrongDateFormatException
    {
        ...
        if ("+-R".lastIndexOf(locTime) == -1) {
            ...
            throw new WrongDateFormatException(dateStr,"time difference relation indicator incorrect; "+
                                               "should be +, - or R and is "+locTime);
        }
        ...
        if ((timeDiff<0) || (timeDiff>48)) {
            ...
            throw new WrongDateFormatException(dateStr,"time difference is incorrect; "+
                                               "should be between 00-48 and is "+timeDiffStr);
        }
    }
